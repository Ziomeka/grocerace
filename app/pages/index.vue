<template>
  <div class="container flex flex-col gap-2">
    <p>
      <span class="font-heading fw-bold text-size-xl color-primary">Grocerace</span> is a real-time shared shopping list app designed for effortless collaboration.
    </p>
    <p>
